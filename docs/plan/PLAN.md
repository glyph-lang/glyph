...
## New priorities (Jan 2026)
- [ ] Glyph umbrella CLI wrapping glyph-cli (new/build/test/run/fmt/doc/add net)
  - [ ] Define command surface and global flags
  - [ ] Decide packaging/wrapping approach over existing glyph-cli
  - [ ] Scaffold UX/help text and initial config (project init)
- [ ] Rust-style mdbook documentation
  - [ ] Outline language guide + compiler internals + contributing
  - [ ] Choose mdbook structure, bootstrap book
  - [ ] Seed initial chapters/TOC
